...
namespace Afosto\ApiClient\Models\_Base\PaymentMethods;
 ...
 * @property number $cost_percentage
 * 
 * @property \Afosto\ApiClient\Models\ExternalServices\ExternalService $external_service
 * @property \Afosto\ApiClient\Models\TaxClasses\TaxClass $tax_class
**/
class BasePaymentMethod extends Model {
    ...
    public function getTypes() {
        return [
            ['','required'],
            ['id','integer'],
            ['name, code, description, instruction','string'],
            ['cost, cost_gross, cost_percentage','number'],
        ];
    }
